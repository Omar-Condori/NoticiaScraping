...
export default function Card({ noticia }) {
  ...
  return (
    <article className="bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl overflow-hidden hover:border-accent-primary/50 transition-all duration-300 hover:shadow-xl hover:shadow-accent-primary/10">
      ...
      <div className="p-5">
        {/* Título */}
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 line-clamp-2 hover:text-accent-primary transition-colors">
          {noticia.titulo}
        </h3>
